    ...
    $.fn.prettyPhoto = function(pp_settings) {
        ...
        */
        $.prettyPhoto.initialize = function() {
            ...
            if (settings.ie6_fallback && parseInt($.browser.version) == 6) settings.theme = "light_square"; // Fallback to a supported theme for IE6
        ...
        */
        ...
        return this.unbind('click.prettyphoto').bind('click.prettyphoto', $.prettyPhoto.initialize); // Return the $ object for chaining. The unbind method is used to avoid click conflict when the plugin is called more than once
    };
