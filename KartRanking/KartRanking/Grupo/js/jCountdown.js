        ...
        var B = function (b) {
            ...
            this.update = function (a) {
                if (a) {
                    ...
                    this.stop();
                    var b = this;
                    this._intervalId = setInterval(function () { b.frame() == b.totalFrames() ? (clearInterval(b._intervalId), b.onFinish()) : b.frame(b.frame() + 1) }, Math.ceil(1E3 / this.fps()))
                } 
                else 
                this.frame(this.totalFrames())
            };
            this.value = function (a, b) {
                if (void 0 == a) return this._value; this._value = a; this.update(b) 
            };
...
Math.ceil(1E3 / this.fps()))
    ...
    this.value = function (a, b) {
        if (void 0 == a)
            return this._value; this._value = a;
        this.update(b)
    };
    this.onFinish = function () { };
    this.destroy = function () {
    ...
    this.width = function (a) {
        if (void 0 == a) return this._width; this._width = a
    };
    this.height = function (a) {
        if (void 0 == a)
            return this._height; this._height = a
    };
    this.frame = function (a) {
        if (void 0 == a)
            return this._frame;
